  ...
  loadScreenings(){
    if(this.consult_details) {
      if(this.consult_details.riskScreeningGlucose){
        this.consult_details.riskScreeningGlucose.date_taken = formatDate(this.consult_details.riskScreeningGlucose.date_taken, 'yyyy-MM-dd', 'en', 'Asia/Manila');
      ...
      if(this.consult_details.riskScreeningLipid){
        this.consult_details.riskScreeningLipid.date_taken = formatDate(this.consult_details.riskScreeningLipid.date_taken, 'yyyy-MM-dd', 'en', 'Asia/Manila');
      ...
      if(this.consult_details.riskScreeningKetones){
        this.consult_details.riskScreeningKetones.date_taken = formatDate(this.consult_details.riskScreeningKetones.date_taken, 'yyyy-MM-dd', 'en', 'Asia/Manila');
      ...
      if(this.consult_details.riskScreeningProtein){
        this.consult_details.riskScreeningProtein.date_taken = formatDate(this.consult_details.riskScreeningProtein.date_taken, 'yyyy-MM-dd', 'en', 'Asia/Manila');
