...
export class InterviewComponent implements OnInit{
  ...
  onSubmit(){
    ...
    if(this.interviewForm.valid && (this.interviewForm.value.source_from_victim_flag || this.interviewForm.value.source_from_historian_flag || this.interviewForm.value.source_from_sworn_statement_flag)) {
      ...
      this.interviewForm.patchValue({
        incident_first_datetime: this.interviewForm.value.incident_first_datetime ? formatDate(this.interviewForm.value.incident_first_datetime, 'yyyy-MM-dd HH:mm:ss', 'en', 'Asia/Manila'): null,
        incident_recent_datetime: this.interviewForm.value.incident_recent_datetime ? formatDate(this.interviewForm.value.incident_recent_datetime, 'yyyy-MM-dd HH:mm:ss', 'en', 'Asia/Manila'): null,
        recant_datetime: this.interviewForm.value.recant_datetime ? formatDate(this.interviewForm.value.recant_datetime, 'yyyy-MM-dd HH:mm:ss', 'en', 'Asia/Manila'): null,
        interview_datetime: this.interviewForm.value.interview_datetime ? formatDate(this.interviewForm.value.interview_datetime, 'yyyy-MM-dd HH:mm:ss', 'en', 'Asia/Manila'): null,
        deferral_datetime: this.interviewForm.value.deferral_datetime ? formatDate(this.interviewForm.value.deferral_datetime, 'yyyy-MM-dd HH:mm:ss', 'en', 'Asia/Manila'): null,
      });
  ...
  interview_behaviors = [
    {id: 1, desc: 'Cooperative',                  var_name: 'behavior_cooperative_flag',        historian_var_name: 'behavior_historian_cooperative_flag'},
    {id: 2, desc: 'Crying, very upset',           var_name: 'behavior_crying_flag',             historian_var_name: 'behavior_historian_crying_flag'},
    {id: 3, desc: 'Clinging to caretaker',        var_name: 'behavior_clinging_flag',           historian_var_name: 'behavior_historian_clinging_flag'},
    {id: 4, desc: 'Responsive to most questions', var_name: 'behavior_responsive_flag',         historian_var_name: 'behavior_historian_responsive_flag'},
    {id: 5, desc: 'Silent, unresponsive',         var_name: 'behavior_silent_flag',             historian_var_name: 'behavior_historian_silent_flag'},
    {id: 6, desc: 'Able to narrate incident',     var_name: 'behavior_able_to_narrate_flag',    historian_var_name: 'behavior_historian_able_to_narrate_flag'},
    {id: 7, desc: 'Unable to narrate incident',   var_name: 'behavior_unable_to_narrate_flag',  historian_var_name: 'behavior_historian_unable_to_narrate_flag'},
    {id: 8, desc: 'Appropriate affect',           var_name: 'behavior_appropriate_affect_flag', historian_var_name: 'behavior_historian_appropriate_affect_flag'},
    {id: 9, desc: 'Depressed affect',             var_name: 'behavior_depressed_affect_flag',   historian_var_name: 'behavior_historian_depressed_affect_flag'},
    {id: 10, desc: 'Flat affect, blank stares',   var_name: 'behavior_flat_affect_flag',        historian_var_name: 'behavior_historian_flat_affect_flag'},
    {id: 11, desc: 'Psychotic symptoms',          var_name: 'behavior_psychotic_flag',          historian_var_name: 'behavior_historian_psychotic_flag'},
    {id: 12, desc: 'Combative, hostile',          var_name: 'behavior_combative_flag',          historian_var_name: 'behavior_historian_combative_flag'},
    {id: 13, desc: 'Hyperactive, anxious',        var_name: 'behavior_hyperactive_flag',        historian_var_name: 'behavior_historian_hyperactive_flag'},
    {id: 14, desc: 'Short attention span',        var_name: 'behavior_short_attention_flag',    historian_var_name: 'behavior_historian_short_attention_flag'},
  ];
  ...
  createForm(){
    this.interviewForm = this.formBuilder.group({
      ...
      source_from_historian_remarks: [null],
      ...
      behavior_historian_cooperative_flag: [false],
      behavior_historian_crying_flag: [false],
      behavior_historian_clinging_flag: [false],
      behavior_historian_responsive_flag: [false],
      behavior_historian_silent_flag: [false],
      behavior_historian_able_to_narrate_flag: [false],
      behavior_historian_unable_to_narrate_flag: [false],
      behavior_historian_appropriate_affect_flag: [false],
      behavior_historian_depressed_affect_flag: [false],
      behavior_historian_flat_affect_flag: [false],
      behavior_historian_psychotic_flag: [false],
      behavior_historian_combative_flag: [false],
      behavior_historian_hyperactive_flag: [false],
      behavior_historian_short_attention_flag: [false],
      behavior_historian_remarks: [null],
