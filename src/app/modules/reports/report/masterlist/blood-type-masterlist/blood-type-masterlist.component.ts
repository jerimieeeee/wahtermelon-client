...
@Component({
  ...
  templateUrl: './blood-type-masterlist.component.html',
  styleUrl: './blood-type-masterlist.component.scss',
  standalone: false
})
export class BloodTypeMasterlistComponent implements OnChanges {
  @Input() report_data;
  @Input() reportForm;
  @Input() selectedBrgy;
